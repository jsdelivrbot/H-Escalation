...
class User extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['username', 'auth_key', 'password_hash', 'password_reset_token', 'email', 'status', 'created_at', 'updated_at', 'employee_id'], 'required'],
    ...
    {
        return $this->hasMany(Ticket::className(), ['closed_by' => 'id']);
    }
