          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="report-monthly.php">Monthly</a></li>
      ...
      <section id="main-content">
          ...
          <br><br>
             <div class="container" style="width:900px;">
               <h2 align="center">Escalated Report</h2>
               <h3 align="center">2017 Monthly Report For Escalated Services</h3>   
               <br /><br />
               <div id="chart"></div>
              </div>
<?php 
