...
class User extends \yii\db\ActiveRecord
{
    ...
    {
       /* return [
            [['username', 'auth_key', 'password_hash', 'password_reset_token', 'email', 'status', 'created_at', 'updated_at', 'employee_id', 'hierarchy_level_id'], 'required'],
            [['status', 'created_at', 'updated_at', 'employee_id', 'hierarchy_level_id'], 'integer'],
    ...
    {
        return $this->hasMany(EscalatedTicket::className(), ['user_id' => 'id']);
    }
