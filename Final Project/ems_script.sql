...
-- Table `hsrrs`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hsrrs`.`user` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `hsrrs`.`hierarchy_level`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hsrrs`.`hierarchy_level` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `hsrrs`.`escalated_ticket`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hsrrs`.`escalated_ticket` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_escalated_ticket_hierarchy_level1`
    ...
    REFERENCES `hsrrs`.`hierarchy_level` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
