...
$query = "SELECT * FROM account3";
$query1 = "SELECT * FROM account2";
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li class="active"><a href="report-holiday.php">Holidays</a></li>
                            <li><a href="report-summer.php">Summer</a></li>
                        </ul>
                      </li>
                  </li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          ...
          <div class="container" style="width:900px;">
           ...
           <h3 align="center">Peak Season Report for Escalated Services(Holiday September-January)</h3>   
           <br /><br />
           <div id="chart"></div>
          </div>
